...
class KasIuranWajibDataTable extends DataTable
{
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                $btn = $btn . '<a href="' . route('user.kas-rt.kas-iuranwajib.edit', $row->id) . '" class="btn btn-dark buttons-edit"><i class="fas fa-edit"></i></a>';
                $btn = $btn . '<a href="' . route('user.kas-rt.kas-iuranwajib.destroy', $row->id) . '" class="btn btn-danger buttons-delete"><i class="fas fa-trash fa-fw"></i></a>';
                $btn = $btn . '<a href="' . route('user.kas-rt.cetak_pdf_wajib', $row->id) . '" class="btn btn-info"><i class="fas fa-file-export"></i></a>';
                $btn = $btn . '</div>';
    ...
    {
        return $model->select('kas_iuran_wajibs.*')->with(['iuranwajib', 'petugastagihan', 'postagihanwajib', 'warga_wajib']);
    }
