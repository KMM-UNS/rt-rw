...
class RekapIuranWajibDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'admin\rekapiuran\rekapiuranwajib.action');
    }
    ...
    {
        return $this->builder()
            ->setTableId('admin\rekapiuran\rekapiuranwajib-table')
    ...
    {
        return 'Admin\RekapIuran\RekapIuranWajib_' . date('YmdHis');
    }
}
