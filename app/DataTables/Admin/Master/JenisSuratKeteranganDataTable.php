...
class JenisSuratKeteranganDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\App\Models\Admin\Master\JenisSuratKeteranganDataTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(JenisSuratKeterangan $model)
    {
    ...
    {
        return $this->builder()
                    ->setTableId('jenissuratketerangandatatable-table')
    ...
    {
        return 'Admin\Master\JenisSuratKeterangan_' . date('YmdHis');
    }
}
