...
class KeperluanSuratDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\App\Models\Admin\Master\JenisSuratDataTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(KeperluanSurat $model)
    {
    ...
    {
        return $this->builder()
                    ->setTableId('jenissuratdatatable-table')
