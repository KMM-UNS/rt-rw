...
class KasIuranSukaRelaController extends Controller
{
    public function index(KasIuranSukaRelaDataTable $dataTable)
    {
        ...
        return $dataTable->render('pages.user.kas-rt.kasiuransukarela.index', compact('sukarela'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.user.kas-rt.kasiuransukarela.add-edit', ['jenis_iuransukarela' => $jenis_iuransukarela, 'nama_petugas' => $nama_petugas, 'nama_bulan' => $nama_bulan, 'tahun' => $tahun]);
    }
    ...
    public function show(KasIuranSukaRelaDataTable $dataTable, $id)
    {
        ...
        // return view('pages.user.kas-rt.kasiuransukarela.show', compact('sukarela'));
    }
    ...
    public function edit($id, DataHelper $dataHelper)
    {
        ...
        $tahun = Tahun::pluck('nama', 'id');
        return view(
            'pages.user.kas-rt.kasiuransukarela.add-edit',
            [
                'data' => $data,
