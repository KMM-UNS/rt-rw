...
<body>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @php
                $status1 = $warga->where('jenis_iuran_id', 7);
                $status2 = $warga->where('jenis_iuran_id', 8);

            @endphp
            {{-- @foreach ($warga as $item1) --}}
            <p>Sudah terima dari Bapak/Ibu <b>{{ $wargaa->warga_wajib->warga }}</b></p>
