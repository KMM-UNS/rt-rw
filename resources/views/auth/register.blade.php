    ...
    <div class="login login-with-news-feed">
        ...
        <div class="right-content">
            ...
            <div class="login-content">
                ...
                @endif
                <form action="{{ request()->routeIs('admin*') ? route('admin.register') : route('register') }}"
                    method="POST" class="margin-bottom-0">
                    @csrf
                    ...
                    <div class="form-group m-b-15">
                        {{-- <x-form.Dropdown name="" :options="$role" selected="{{{ old('') ?? ($data[''] ?? null) }}}" required /> --}}
                    </div>
