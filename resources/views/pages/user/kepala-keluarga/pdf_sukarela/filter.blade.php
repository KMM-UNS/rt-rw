                                ...
                                <tbody>
                                    ...
                                    @foreach ($warga as $item)
                                        <tr>
                                            ...
                                            @endphp
                                            <td>
                                                @foreach ($item->warga_sukarela->where('jenis_iuran_id', 1) as $i)
                                            ...
                                            <td>
                                                @foreach ($item->warga_sukarela->where('jenis_iuran_id', 2) as $j)
                                    ...
                                    <td colspan="cols-1">
                                        ...
                                        @if (count($warga) == count($status4))
                                            <a href="{{ route('user.kepala-keluarga.cetak_kebersihan', [$bulan, $tahun]) }}"
                                                class="btn btn-primary" target="_blank">CETAK
                                                PDF</a>
                                        @else
                                            <a href="#" class="btn btn-primary disabled" target="_blank">CETAK
