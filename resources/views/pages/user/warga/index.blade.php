                ...
                <tbody>
                  <tr>
                    <td class="with-img text-center">
                        ...
                        {{-- image --}}
                        <img src="{{ asset($warga->dokumen[0]['public_url']) }}" class="img-rounded height-70" data-toggle="modal" data-target="#exampleModal" style="
                            object-fit: cover;
                            border-radius: 50%;
                            width: 70px;
                            height: 70px;"
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">{{ $warga->nama }}</h5>
