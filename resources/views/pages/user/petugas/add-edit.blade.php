                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="ttgl" name="ttgl" class="form-control" autofocus data-parsley-required="true" value="{{{ $data->ttgl ?? old('ttgl') }}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="tahun">No.Telpon</label>
                                            <input type="text" id="no_telp" name="no_telp" class="form-control" autofocus data-parsley-required="true" value="{{{ $data->no_telp ?? old('no_telp') }}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="petugas">Alamat</label>
