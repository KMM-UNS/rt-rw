...
<!-- begin panel -->
<form action="{{ isset($data) ? route('admin.kas-rt.kas-iurankondisional.update', $data->id) : route('admin.kas-rt.kas-iurankondisional.store') }}" id="form" name="form" method="POST" data-parsley-validate="true">
  @csrf
  @if(isset($data))
  {{ method_field('PUT') }}
  @endif
