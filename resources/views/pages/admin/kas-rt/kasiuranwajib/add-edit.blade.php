...
<!-- begin panel -->
<form action="{{ isset($data) ? route('admin.kas-rt.kas-iuranwajib.update', $data->id) : route('admin.kas-rt.kas-iuranwajib.store') }}" id="form" name="form" method="POST" data-parsley-validate="true">
  @csrf
  @if(isset($data))
  {{ method_field('PUT') }}
  @endif
  ...
  <div class="panel panel-inverse">
    ...
    <div class="panel-body">
      <div class="form-group">
        ...
        <x-form.Dropdown name="jenis_iuran_id" :options="$jenis_iuranwajib" selected="{{{ old('jenis_iuran_id') ?? ($data['jenis_iuran_id'] ?? null) }}}" required />
      </div>
      <div class="form-group">
