...
<!-- begin panel -->
<form action="{{ isset($data) ? route('admin.aplikasi.update', $data->id) : route('admin.aplikasi.store') }}" id="form" name="form" method="POST" data-parsley-validate="true" enctype="multipart/form-data">
  @csrf
  @if(isset($data))
  {{ method_field('PUT') }}
  @endif
    ...
    {{-- <div class="row"> --}}
        ...
        @elseif(auth()->user()->hasRole('ketua_rt'))
        <div class="col-xl-3 ui-sortable mx-auto">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    $imageSrc = $data->dokumen->where('nama', 'ttd_rt')->toArray();
                    }
                    @endphp
                    <div class="row">
