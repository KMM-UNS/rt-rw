          ...
          <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-1 my-auto">
                            <label for="warga_id"><strong>Kepala Keluarga</strong></label>
                        </div>
                        <div class="col-md-5">
                            <div class="input-group">
                                {{-- <x-form.Dropdown name="rumah_warga_id" :options="" selected="{{{ old('rumah_warga_id') ?? ($data['warga_id'] ?? null) }}}" required /> --}}
                            </div>
                        </div>
                        <div class="col-md-1 my-auto">
                            <label for="telp"><strong>Telepon</strong></label>
                        </div>
                        <div class="col-md-5">
                            <div class="input-group">
                                <input type="text" id="telp" name="rumah_telp" class="form-control" autofocus data-parsley-required="true" value="{{{ old('rumah_telp') ?? ($data['telp'] ?? null) }}}">
                            </div>
                        </div>
                    </div>
                </div>
