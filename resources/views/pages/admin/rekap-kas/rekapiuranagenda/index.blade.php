...
@section('content')
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item"><a href="javascript:;">Rekap Iuran Agenda</a></li>
        <li class="breadcrumb-item active">@yield('title')</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Rekap Iuran Agenda<small> @yield('title')</small></h1>
    <!-- end page-header -->
