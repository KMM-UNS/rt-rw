...
@section('title', isset($data) ? 'Edit Status Hunian' : 'Create Status Hunian' )
...
<!-- begin panel -->
<form action="{{ isset($data) ? route('admin.master-data.status-hunian.update', $data->id) : route('admin.master-data.status-hunian.store') }}" method="POST" data-parsley-validate="true">
  @csrf
  @if(isset($data))
  @method('PUT')
  @endif
