...
@section('title', isset($data) ? 'Edit Ronda' : 'Create Ronda' )
...
<!-- begin panel -->
<form action="{{ isset($data) ? route('admin.master-data.ronda.update', $data->id) : route('admin.master-data.ronda.store') }}" id="form" name="form" method="POST" data-parsley-validate="true">
  @csrf
  @if(isset($data))
  {{ method_field('PUT') }}
  @endif
