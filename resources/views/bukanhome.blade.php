    ...
    <div id="page-container" class="fade">
                ...
                <div class="collapse navbar-collapse" id="header-navbar">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active dropdown">
                            <a href="#home" data-click="scroll-to-target" data-toggle="dropdown">HOME <b
                                    class="caret"></b></a>
        ...
        <div id="home" class="content has-bg home">
            ...
            <div class="content-bg">
                <img src="../assets/img/bg/bg-home.jpg" alt="Home" />
            </div>
            <!-- end content-bg -->
            <!-- begin container -->
                        ...
                        <div class="service">
                            ...
                            <div class="info">
                                ...
                                <p class="desc">Duis in lorem placerat, iaculis nisi vitae, ultrices tortor.
                                    Vestibulum molestie ipsum nulla. Maecenas nec hendrerit eros, sit amet maximus leo.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="service">
                            ...
                            <div class="info">
                                ...
                                <p class="desc">Etiam nulla turpis, gravida et orci ac, viverra commodo ipsum. Donec
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="service">
                            ...
                            <div class="info">
                                ...
                                <p class="desc">Quisque gravida metus in sollicitudin feugiat. Class aptent taciti
                ...
                <div class="carousel testimonials slide" data-ride="carousel" id="testimonials">
                    ...
                    <div class="carousel-inner text-center">
                        ...
                        <div class="item active">
                            <blockquote>
                                <i class="fa fa-quote-left"></i>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce viverra, nulla ut
                                interdum fringilla,<br />
            ...
            <div class="theme-panel-content">
                <ul class="theme-list clearfix">
                    ...
                    <li><a href="javascript:;" class="bg-blue" data-theme="blue"
                            data-theme-file="../assets/css/one-page-parallax/theme/blue.css" data-theme-file=""
                            data-click="theme-selector" data-toggle="tooltip" data-trigger="hover"
                            data-container="body" data-title="Blue">&nbsp;</a></li>
                    <li class="active"><a href="javascript:;" class="bg-green"
                            data-theme-file="../assets/css/one-page-parallax/theme/default.css" data-theme-file=""
                            data-theme="default" data-click="theme-selector" data-toggle="tooltip"
                            data-trigger="hover" data-container="body" data-title="Default">&nbsp;</a></li>
                    <li><a href="javascript:;" class="bg-orange" data-theme="orange"
                            data-theme-file="../assets/css/one-page-parallax/theme/orange.css" data-theme-file=""
                            data-click="theme-selector" data-toggle="tooltip" data-trigger="hover"
                            data-container="body" data-title="Orange">&nbsp;</a></li>
                    <li><a href="javascript:;" class="bg-red" data-theme="red"
                            data-theme-file="../assets/css/one-page-parallax/theme/red.css" data-theme-file=""
                            data-click="theme-selector" data-toggle="tooltip" data-trigger="hover"
                            data-container="body" data-title="Red">&nbsp;</a></li>
                </ul>
            </div>
        </div>
        <!-- end theme-panel -->
